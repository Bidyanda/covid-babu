        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Go to Inventory', 'icon' => 'chain', 'url' => ['/plan-enrollment/subscribers']],
                    ['label' => 'Daily Update 8pm - 9pm', 'icon' => 'chain', 'url' => ['/plan-enrollment/subscribers']],
                    ['label' => 'Export Excel', 'icon' => 'chain', 'url' => ['/plan-enrollment/subscribers']],
                    ['label' => 'Update Lab Capacity', 'icon' => 'chain', 'url' => ['/plan-enrollment/subscribers']],
